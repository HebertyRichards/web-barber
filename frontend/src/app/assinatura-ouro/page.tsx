    ...
    <>
      ...
      <div className="flex justify-center mt-6">
        <div className="w-full max-w-md">
          <div className="bg-[#f6d300] text-black text-center font-semibold p-4 uppercase">
            {prata?.nome}
          </div>
          <div className="bg-[#f6d300] text-black text-center text-xl font-bold p-4">
            {prata?.preco}
          </div>
              ...
              <tbody>
                ...
                <tr>
                  <td className="py-4">
                    <Link
                      href="#"
                      className="bg-[#f6d300] text-black mt-auto inline-block font-semibold px-4 py-2 hover:bg-yellow-400"
                    >
                      Assinar
                    </Link>
                  </td>
