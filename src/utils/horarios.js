export function gerarHorariosDisponiveis(data, horariosIndisponiveis) {
  const horarios = [
    "08:00",
    "08:30",
    "09:00",
  ...
  // Calcula a hora atual formatada
  ...
  // Filtra os horários disponíveis e retorna uma lista de horários
